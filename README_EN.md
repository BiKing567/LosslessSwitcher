...
This localized version is based on the upstream 2.0 branch and targets macOS Sequoia 15.4 and later. The current release is RateSync 3.2.2; please download the latest version from the [Releases page](https://github.com/BiKing567/RateSync/releases).
